...
INCLUDED_DIR = -I$(SOURCE_DIR)/$(TEMPLATE_DIR)
CXX = clang++
...
$(BUILD_DIR)/test.o: $(TEST_DIR)/test.cpp $(SOURCE_DIR)/$(TEMPLATE_DIR)/linked_list.tpp $(SOURCE_DIR)/$(TEMPLATE_DIR)/list_buffer.tpp
